...
const FunctionComponent = () => {
  ...
  notes: {
    6: "Create a memoized callback function that doesn't change until value of a dependency changes.",
    7: "Create a memoized callback function that doesn't change until value of a dependency changes.",
    8: "Create a memoized callback function that doesn't change until value of a dependency changes.",
  },
  fontSize: 13,
